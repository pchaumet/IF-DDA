...
c     variables for the object
     ...
     $     ,ntotal,nmaxpp
      ...
      parameter (nxm=52,nym=54,nzm=56,nphi=72,ntheta=36)
...
c********************************************************
c      beam='pwavelinear'        !Linear Gaussian wave
      beam='wavelinearmulti'    !Multiple linear plane wave
...
c     object='randomsphere1'    !Random spheres in box with side given
      object='randomsphere2'    !Random spheres in box with nx,ny,nz,aretecube given
