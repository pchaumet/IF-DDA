...
c     (2) inside the boxnx+2*nxmp,ny+2*nymp,nz+2*nzmp
      ...
      nxmp=1                    ! if nproche=2 used then the addsize along x : nx+2*nxmp
      nymp=2                    ! if nproche=2 used then the addsize along y : ny+2*nymp
      nzmp=3                    ! if nproche=2 used then the addsize along z : nz+2*nzmp
...
c     (6) BPM, (7) renormalized BPM.
      ...
      nforce=1                  ! (0) Do not compute or (1) compute the optical force.
      nforced=1                 ! (0) Do not compute or (1) compute the density of optical force.
      ntorque=1                 ! (0) Do not compute or (1) compute the optical torque.
      ntorqued=1                ! (0) Do not compute or (1) compute the density of optical torque.
      
      nsection=1                ! 0 do not compute the cross section, 1 compute the cross section. 
      nsectionsca=1             !1: calcul C_sca, Poynting and g with radiating dipole.
      ...
      nquad=2                   !0 -> 5 define the level of integration of the Green tensor.
