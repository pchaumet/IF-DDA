      ...
      subroutine hdf5write2d(file_id, datasetname, data0, dim0)
#ifdef USE_HDF5
         ...
         double precision , dimension(dim0(3),dim0(4)) :: data0
         ...
         integer(hsize_t), dimension(1:2) :: dimsmem !dimension memspace
     ...
     &   memoffset, memcount, error, memstride, memblock)
         ...
         !ecrit le dataset
         call h5dwrite_f(dataset_id, H5T_NATIVE_DOUBLE, data0, dims,
