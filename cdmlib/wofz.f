...
*
      double complex zz
      LOGICAL A, B, FLAG
      PARAMETER (FACTOR   = 1.6437916709551257388D0,
     *           RMAXREAL = 0.5D+154,
...
C
        ...
        DO 10 I=N, 1, -1
          ...
          XSUM = XAUX + 1.d0/J
 10     CONTINUE
        U1   = -FACTOR*(XSUM*YABS + YSUM*XABS) + 1.d0
